...
```text
ก็คือ input แรกจะได้จำนวน
คำสั่งมาเป็น +, - เท่านั้น

ถ้าา +  ก็แค่ +10 จากค่าเดิม
ถ้า - ก็แค่ - 5 จากค่าเดิม
```
...
```text
ก็ for loop รับ input ซึ่งเป็น + หรือ ลบ มาเลย

แล้วก็ if-else condition statement มาว่าเป็น + หรือ เป็น -
หาก + ก้ให้บวก ค่าเดิมไป 10
หาก เป็้น - ก็ให้ลบค่าเดิมไป 5
```
...
```text
ผมก็ใช้ตามแผนแรกที่ผมใ้เล้ยยยย
...
```text
check ว่า operation cmd เวิ้คปกติไหม ควรรจะได้ 15
```
...
```text
check ว่า operation cmd เวิ้คปกติไหม ควรจะได้ negative number
```
...
```text
check ว่า operation cmd เวิ้คปกติไหม ควรจะได้ 0
```
