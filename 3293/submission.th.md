...
```text
ไอเดียคือหาให้เจอว่าใน 5 บรรทัดนั้น อันไหนยาวสุด จะได้กำหนดความกว้างของกรอบ 
จากนั้นก็แค่เอาข้อความไปแปะตรงกลางกรอบ โดยต้องเว้นช่องว่างซ้ายขวาฝั่งละ 1 ช่องเสมอ ประมารนนัี้ 
```
...
```text
รับข้อความมา 5 บรรทัดก่อน
แล้วหาดูว่าบรรทัดไหนยาวสุด จะได้รู้ว่าต้องตีตีกรอบกว้างแค่ไหน
หลังจากนั้นก็จัดดอกจันยาวป็นขอบบนกับขอบล่าง
ส่วนไส้ในก็เอาแต่ละบรรทัดมาประกบข้างซ้ายขวาด้วย risky asterisk แล้วยัดwhite spaceให้มันเต็มกรอบสี่เหลี่ยม
```
...
```text
ก็เป็นวิธีแรกที่ผมบอกไปเลยยย
หา maximum length เพื่อจะได้ตีกรอบได้ แล้วก็ยัด vertical asterisk เข้าไปซ้ายขวา แค่นันัน้นน
```
...
```text
Hi
bruhbruhis is a very long text
ok
1
2
```
