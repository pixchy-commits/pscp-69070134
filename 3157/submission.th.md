...
```text
รับค่า N (จำนวนคำสั่ง) 

สร้างตัวแปร score = 0 เพื่อเก็บคะแนนสะสม

วนลูปจำนวน N รอบ เพื่อรับคำสั่งทีละบรรทัด

ในแต่ละรอบ ถ้ารับค่าเป็น '+' ให้ score บวกเพิ่ม 10

ถ้ารับค่าเป็น '-' ให้ score ลดลง 5

เมื่อจบลูป ให้แสดงผลตัวแปร score
```
...
```text
ใช้ตามแผนแรก และ mental model ที่คิดไวอธิบายไว้ตอนแรก
```
