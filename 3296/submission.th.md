...
```text
หา pattern ง่ายๆก็คือ เอา r1 + r2, b1 + b2, g1 + g2 แล้วให้ ทุกพจน์ หารด้วยสองเพื่อการค่าเฉลี่ยนก้จะได้สิ่งที่โจทย์ต้องการ
```
...
```text
1) รับ str บรรทัดแลกมาแลว split ได้ R1, G1, B1
2) ทำเช่นกันกับ R2, G2, B2

จับบวกกันหารด้วยสองและปัดเศษทิ้ง(ลง) (R1+R2)//2, (G1+G2)//2, (B1+B2)//2
